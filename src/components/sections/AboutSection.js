...
const AboutSection = () => {
  return (
    <article id="about" className="px-[2rem] notebook:px-[7.5rem]  desktop:px-[10rem] py-[2.5rem] notebook:py-[3.5rem] desktop:py-[5rem] animate-opacityChangeX bg-white ">
      <Title text={"about me"} />
      <div className="flex flex-col notebook:flex-row  my-[1rem] ">
        <div className="text-[.7rem] notebook:text-[1rem] desktop:text-[1.2rem] notebook:w-2/3 mr-[2rem]">
        ...
        <div className="relative z-10">
         ...
         notebook:-right-[0.5rem] desktop:-right-[5rem]   notebook:top-[0.5rem] desktop:top-[1rem]
         notebook:h-[15rem]  notebook:w-[15rem] desktop:w-[20rem]  desktop:h-[20rem] 
         notebook:hover:-right-[0.25rem] notebook:hover:top-[0.25rem] desktop:hover:-right-[4.75rem] desktop:hover:top-[.75rem] ease-in-out duration-300 "
          />
        </div>
      </div>
    </article>
